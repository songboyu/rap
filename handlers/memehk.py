...
def upload_head_memehk_forum(src):
    logger = RAPLogger('Upload head memhk_forum=>' + src['username'])
    sess = RAPSession(src)
    ...
    resp = sess.post('http://forum.memehk.com/uc_server/index.php', data=payload, params=params)
